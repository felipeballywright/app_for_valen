...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://asxgqfwfctgxcotuctlu.supabase.co");
const supabaseKey = ("TURBOPACK compile-time value", "sb_publishable_ee0qDYCzOmcfh3raz9-B1A_ZbegKC44");
...
async function Home(props) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from("tokens_table").select("*").eq("token", token).single();
    if (error || !data) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if (data.used) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: "You already selected a video"
        }, void 0, false, {
            fileName: "[project]/app/page.tsx",
            lineNumber: 21,
            columnNumber: 12
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0x~9l1i._.js.map